        ...
        <div className="flex flex-grow flex-col items-center gap-5 md:flex-row">
          ...
          <div className="flex flex-col justify-center gap-1 ">
            <TextElement
              as="p"
              type="t3"
              className="text-center !font-semibold leading-[24px] md:text-start "
            >
            ...
            <TextElement
              as="p"
              type="base"
              className="break-all text-center !font-light md:text-start"
            >
              {loggedUser?.email}
            </TextElement>
          </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              ...
              <b className="break-all font-semibold">
