...
export const locationData = convertArrayToValueLabelArray([
  'Remote',
  'On-site',
  'Hybrid'
])

export const typeData = convertArrayToValueLabelArray([
  'Full-time',
  'Part-time',
  'Contract',
  'Internship',
...
export const countryData = convertArrayToValueLabelArray([
  'United States',
  'England',
  'India'
])
